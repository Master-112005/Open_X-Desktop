...
const AppliancePatternLearner = require('../home-learning/AppliancePatternLearner');

class AppliancePatternLearning extends BaseLearningModule {
  constructor(options = {}) {
    super(options);
    ...
    this.learner = options.learner || new AppliancePatternLearner(options);
  }
  ...
  learn(context) {
    ...
    if (!collected.valid) {
      context.addRejected({ category: 'pattern', key: 'home.device', reason: collected.reason });
      return context;
    }
...
module.exports = AppliancePatternLearning;
