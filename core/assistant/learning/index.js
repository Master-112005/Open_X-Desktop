...
module.exports = {
  ...
  DevicePreferenceLearning: require('./DevicePreferenceLearning'),
  AppliancePatternLearning: require('./AppliancePatternLearning'),
  ActionSequenceLearning: require('./ActionSequenceLearning'),
