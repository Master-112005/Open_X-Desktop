...
const PHRASE_REPLACEMENTS = [
  ...
  { from: /\bsend\s+(it|that|this)\s+over\s+to\s+(?:my\s+)?phone\b/g, to: 'send $1 to my phone' },
  { from: /\bsend\s+(it|that|this)\s+across\s+to\s+(?:my\s+)?phone\b/g, to: 'send $1 to my phone' },
  { from: /\bcopy\s+(.+?)\s+onto\s+(?:my\s+)?phone\b/g, to: 'copy $1 to my phone' },
  { from: /\bput\s+(.+?)\s+on\s+(?:my\s+)?phone\b/g, to: 'send $1 to my phone' },
