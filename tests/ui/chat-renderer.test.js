...
describe('Chat Renderer UI', function() {
  ...
  it('should expose OpenX Chat as an Apps surface with a WhatsApp-style local chat layout', function() {
    ...
    assert.match(html, /id="people-chat-server-url"[\s\S]*id="people-chat-country-code"[\s\S]*id="people-chat-phone"[\s\S]*id="people-chat-otp"[\s\S]*id="people-chat-pin"/);
    assert.match(html, /id="people-chat-development-code"[\s\S]*Development code[\s\S]*id="people-chat-development-code-value"/);
    assert.match(html, /id="people-chat-add-user"[\s\S]*id="people-chat-user-name"[\s\S]*id="people-chat-user-country-code"[\s\S]*id="people-chat-user-id"/);
    ...
    assert.match(script, /const peopleChatUserCountryCodeEl = document\.getElementById\('people-chat-user-country-code'\)/);
    ...
    assert.match(script, /const peopleChatCountryCodeEl = document\.getElementById\('people-chat-country-code'\)/);
    assert.match(script, /const peopleChatDevelopmentCodeEl = document\.getElementById\('people-chat-development-code'\)/);
    assert.match(script, /message\.match\(\/development verification code/);
    assert.match(script, /Development code is shown below/);
    assert.match(script, /countryCode/);
    ...
    assert.match(css, /\.people-chat-development-code/);
